...
var Whms = /** @class */ (function () {
     ...
     * @param uploadConfig
     */
    Whms.prototype.upload = function (uploadConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        var eList, pList, employee, projectId, workRecordConfig, dStart, dEnd, days, dateArr, i, curDate, pendArr, itemNameArr, _i, dateArr_1, date, resArr;
                        var _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                ...
                                case 2:
                                    ...
                                    if (!employee) {
                                        return [2 /*return*/, reject("Invalid employee: Can't find a match.")];
                                    }
                                    workRecordConfig = {
                                        employee: employee,
                                        projectId: projectId,
                                    ...
                                    dateArr = [];
                                    for (i = 0; i < days; i++) {
                                        curDate = new Date(dStart);
                                        curDate.setDate(curDate.getDate() + i);
                                        dateArr.push(curDate);
                                    }
                                    pendArr = [];
                                    itemNameArr = [];
                                    for (_i = 0, dateArr_1 = dateArr; _i < dateArr_1.length; _i++) {
                                        date = dateArr_1[_i];
                                        if (uploadConfig.exclude.includes(date.toString()))
                                            continue;
                                        if (uploadConfig.passHoliday && (date.getDay() == 0 || date.getDay() == 6))
                                            continue;
                                    ...
                                    return [4 /*yield*/, Promise.all(pendArr)];
                                case 3:
                                    resArr = _b.sent();
                                    return [2 /*return*/, resolve(resArr.map(function (res, idx) {
                                            return {
