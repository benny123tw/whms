...
var Whms = /** @class */ (function () {
    ...
    Whms.prototype.upload = function (uploadConfig) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        var eList, pList, employee, projectId, workRecordConfig, dStart, dEnd, days, msgArr, i, currentDate, res;
                        var _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 3:
                                    ...
                                    return [4 /*yield*/, this.save(this.generateWorkReocrd(workRecordConfig))];
                                case 4:
                                    res = _b.sent();
