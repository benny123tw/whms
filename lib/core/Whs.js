...
var Whs = /** @class */ (function () {
    function Whs(baseConfig) {
        this.section = [
     ...
     * @param data
     */
    Whs.prototype.saveToLocal = function (path, filename, data) {
     ...
     */
    Whs.prototype.get = function (config) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * @returns AxiosResponse
     */
    Whs.prototype.post = function (config) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * @returns
     */
    Whs.prototype.save = function (workRecordList) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
     ...
     * @returns WorkRecord[]
     */
    Whs.prototype.generateWorkReocrd = function (workRecordConfig) {
        var serial = 1;
        var workRecordList = [];
